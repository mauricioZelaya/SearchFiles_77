...
# Text = StringVar()
#
# label = Entry(root, textvariable=Text)
# label.pack()
# browse_button = Button(root, text="Browse", command=browse_func(MyText))
# browse_button.pack()
#
# mainloop()
...
# root = Tk()
# v = StringVar()
# button2 = Button(text="Select Path", command=browse_button).grid(row=0, column=3)
# label = Entry(root, textvariable=v).grid(row=1, column=3)
#
#
# mainloop()
